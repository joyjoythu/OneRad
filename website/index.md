...
hero:
  name: OneRad
  text: 影像组学智能体使用指南
  tagline: 用自然语言完成 DICOM 转换、特征提取、LASSO 建模、SHAP 可解释性分析与 Word 报告生成
  actions:
    - theme: brand
      text: 快速上手 →
...
features:
  ...
  - icon: ⏸️
    title: 断点续提
    details: 每例特征提取完成即写入 h5 缓存，中断或新增病例后从断点继续，绝不重复计算。
  - icon: 🧠
    title: 项目记忆
    details: ID 列、Label 列、分析偏好一次确认，项目内所有对话共享——跨线程的记忆，而非简单的历史记录。
  - icon: 📄
    title: 学术级 Word 报告
    details: 中文学术格式自动排版：方法学描述、结果表格、ROC / 校准 / DCA / SHAP 图表，可直接放入论文附件。
---
